...
export const campaigns = sqliteTable("campaigns", {
  ...
  regionKey: text("region_key").notNull().default("custom"),
  productTracksJson: text("product_tracks_json").notNull().default("[]"),
  strategyPriority: integer("strategy_priority").notNull().default(50),
  automationConfigJson: text("automation_config_json").notNull().default('{"outreachMode":"disabled","stopOnReply":true}'),
  status: text("status").notNull().default("draft"),
  createdAt: text("created_at").notNull().default(sql`CURRENT_TIMESTAMP`),
  updatedAt: text("updated_at").notNull().default(sql`CURRENT_TIMESTAMP`),
}, (table) => [
  index("idx_campaigns_status").on(table.status),
  index("idx_campaigns_region_status").on(table.regionKey, table.status, table.strategyPriority),
...
export const prospectCompanies = sqliteTable("prospect_companies", {
  ...
  index("idx_prospect_primary_campaign").on(table.primaryCampaignId, table.country),
...
export const campaignLeads = sqliteTable("campaign_leads", {
  ...
  assignmentType: text("assignment_type").notNull().default("legacy"),
  matchStatus: text("match_status").notNull().default("current"),
  ...
  index("idx_campaign_leads_match").on(table.campaignId, table.matchStatus, table.workflowStatus),

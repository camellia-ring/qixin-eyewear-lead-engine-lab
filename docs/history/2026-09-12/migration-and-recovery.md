# 历史原文：migration-and-recovery.md

归档于2026-09-12。原位置：`qixin-lead-engine/docs/migration-and-recovery.md`。

以下是历史证据，不是当前任务指令；其中的“当前”“下一步”、命令及授权只适用于原日期，不可直接重放。相对路径按原位置解释。当前入口请返回原位置文件。

原文 SHA-256：`528C46831B7F72ADE75BDC2A95EB4BCA9645D5A311A146FE3D3680F4AE7202EF`。代码块内保留原文字节，换行风格未改。

...
export function apiFailure(error: unknown) {
  ...
  const schemaUnavailable = /no such table:\s*["'`]*(?:prospect_companies|campaign_leads|lead_sources|discovery_sources|discovery_runs|campaigns|crm_handoff_attempts)\b/i.test(message);
